...
public class ReportPurchasesCreditOnlyRetrieve {
	...
	public static void setWorkbook( XSSFWorkbook workbook ) {
		ReportPurchasesCreditOnlyRetrieve.workbook = workbook;
	}
	...
	public static List < Purchase > exportList( String sheetName, ObservableList < String > columns ) {
		...
		try {
			...
			preparedStatement = connection
					.prepareStatement( DBUtils.getRetrievingCommandString( "purchases", "WHERE is_credit=1" ) );
