...
public class ReportPurchasesCashOnlyRetrieve {
	...
	public static void setWorkbook( XSSFWorkbook workbook ) {
		ReportPurchasesCashOnlyRetrieve.workbook = workbook;
	}
	...
	public static List < Purchase > exportList( String sheetName, ObservableList < String > columns ) {
		...
		try {
			...
			preparedStatement = connection
					.prepareStatement( DBUtils.getRetrievingCommandString( "purchases", "WHERE is_credit=0" ) );
