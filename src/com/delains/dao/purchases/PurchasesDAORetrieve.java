...
public class PurchasesDAORetrieve {
	...
	public static List < Purchase > findAllPurchases() {
		...
		try {
			...
			while ( resultSet.next() ) {
				...
				purch.setMediumOfPaymentId( mapMediumOfPayment.get( mediumOfPaymentId ) );
	...
	public static void setWorkbook( XSSFWorkbook workbook ) {
		PurchasesDAORetrieve.workbook = workbook;
	}

	@SuppressWarnings( "deprecation" )
	public static List < Purchase > exportList( String sheetName, ObservableList < String > columns,
			String whereQuery ) {
		...
		try {
			...
			preparedStatement = connection
					.prepareStatement( DBUtils.getRetrievingCommandString( "purchases", whereQuery ) );
			resultSet = preparedStatement.executeQuery();
