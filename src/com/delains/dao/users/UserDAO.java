...
public class UserDAO {
	...
	public static void newUser( User user ) {
		createTableUsers();
		UserDAOinsertion.newUser( user );
	}

	public static void updateUser( User user, BigDecimal idOfUser ) {
		UserDAOUpdate.updateUser( user, idOfUser );
	}
	...
	public static void main( String [ ] args ) {
		...
		System.out.println( changeListUtilToListObservable() );
		...
		//
		// System.out.println("em: " + user.getUserEmail());
		//
		// newUser(user);
		//
