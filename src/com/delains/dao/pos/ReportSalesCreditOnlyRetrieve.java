...
public class ReportSalesCreditOnlyRetrieve {
	...
	public static void setWorkbook( XSSFWorkbook workbook ) {
		ReportSalesCreditOnlyRetrieve.workbook = workbook;
	}
	...
	public static Map < BigDecimal, POS > exportList( String sheetName, ObservableList < String > columns ) {
		...
		try {
			...
			preparedStatement = connection
					.prepareStatement( DBUtils.getRetrievingCommandString( "pos", "where credit=1" ) );
			// preparedStatement.setString( 1, whereQuery );
