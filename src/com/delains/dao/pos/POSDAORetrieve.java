...
public class POSDAORetrieve {

	@SuppressWarnings( "deprecation" )
	public static Map < BigDecimal, POS > findAllPOSesMappedToTheirIDs() {
		...
		try {
			...
			while ( resultSet.next() ) {
				...
				System.out.println( "............................." + Timestamp.valueOf( date ).getDate() );
				...
				pos.setMediumOfPaymentId( mapMediumOfPayment.get( mediumOfPaymentId ) );
	...
	public static void setWorkbook( XSSFWorkbook workbook ) {
		POSDAORetrieve.workbook = workbook;
	}
	...
	public static Map < BigDecimal, POS > exportList( String sheetName, ObservableList < String > columns,
		...
		try {
			...
			preparedStatement = connection.prepareStatement( DBUtils.getRetrievingCommandString( "pos", whereQuery ) );
			resultSet = preparedStatement.executeQuery();
