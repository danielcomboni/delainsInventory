...
public class SalesReturnDAORetrieve {

	public static List < SalesReturn > findAllSalesReturns() {
	...
	public static void setWorkbook( XSSFWorkbook workbook ) {
		SalesReturnDAORetrieve.workbook = workbook;
	}
	...
	public static List < SalesReturn > exportList( String sheetName, ObservableList < String > columns,
		...
		try {
			...
			preparedStatement = connection
					.prepareStatement( DBUtils.getRetrievingCommandString( "sales_return", whereQuery ) );
			resultSet = preparedStatement.executeQuery();
