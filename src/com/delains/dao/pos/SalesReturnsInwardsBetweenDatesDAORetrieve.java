...
public class SalesReturnsInwardsBetweenDatesDAORetrieve {
	...
	public static void setWorkbook( XSSFWorkbook workbook ) {
		SalesReturnsInwardsBetweenDatesDAORetrieve.workbook = workbook;
	}
	...
	public static List < SalesReturn > exportList( String sheetName, ObservableList < String > columns, String dateFrom,
		...
		try {
			...
			preparedStatement = connection.prepareStatement(
					DBUtils.getRetrievingCommandString( "sales_return", "WHERE DATE(date) between ? AND ? " ) );
