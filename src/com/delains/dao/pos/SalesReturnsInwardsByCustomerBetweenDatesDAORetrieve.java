...
public class SalesReturnsInwardsByCustomerBetweenDatesDAORetrieve {
	...
	public static void setWorkbook( XSSFWorkbook workbook ) {
		SalesReturnsInwardsByCustomerBetweenDatesDAORetrieve.workbook = workbook;
	}

	@SuppressWarnings( "deprecation" )
	public static List < SalesReturn > exportList( String sheetName, ObservableList < String > columns, String dateFrom,
			String dateTo, BigDecimal customerID ) {
		...
		try {
			...
			preparedStatement = connection.prepareStatement( DBUtils.getRetrievingCommandString( "sales_return",
					"WHERE DATE(date) between ? AND ? AND customer_id=?" ) );
