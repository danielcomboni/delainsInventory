...
public class ReportAllSalesCashBetweenDatesRetrieve {
	...
	public static void setWorkbook( XSSFWorkbook workbook ) {
		ReportAllSalesCashBetweenDatesRetrieve.workbook = workbook;
	}
	...
	public static Map < BigDecimal, POS > exportList( String sheetName, ObservableList < String > columns,
		...
		try {
			...
			preparedStatement = connection.prepareStatement(
					DBUtils.getRetrievingCommandString( "pos", "WHERE DATE(date) between ? AND ? AND credit=0" ) );
