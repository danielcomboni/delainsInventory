...
public class ReportAllSalesCreditByCustomerRetrieve {
	...
	public static void setWorkbook( XSSFWorkbook workbook ) {
		ReportAllSalesCreditByCustomerRetrieve.workbook = workbook;
	}
	...
	public static Map < BigDecimal, POS > exportList( String sheetName, ObservableList < String > columns,
		...
		try {
			...
			preparedStatement = connection
					.prepareStatement( DBUtils.getRetrievingCommandString( "pos", "WHERE customer_id=? AND credit=1" ) );
