...
public class SupplierTypeHibernation {
	...
	public static void newSupplierType(SupplierType supplierType) {
		SupplierTypeDAO.newSupplierType(supplierType);
	}

	public static void updateSupplier(SupplierType supplierType, BigDecimal idOfSupplierType) {
		SupplierTypeDAO.updateSupplierType(supplierType, idOfSupplierType);
	}
