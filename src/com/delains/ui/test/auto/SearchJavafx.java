...
public class SearchJavafx  extends Application{
    ...
    public void start(Stage ps) throws Exception {
        ...
        entriess.add(new Address(50, "Main Street", "Oakville", "Ontario"));
        entriess.add(new Address(3, "Fuller Road", "Toronto", "Ontario"));
