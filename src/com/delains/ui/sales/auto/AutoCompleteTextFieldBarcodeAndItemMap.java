package com.delains.ui.sales.auto;
 ...
 * @param <S>
 */
public class AutoCompleteTextFieldBarcodeAndItemMap<S> extends TextField
{
     ...
     * @param entrySet
     */
    public AutoCompleteTextFieldBarcodeAndItemMap(List<S> entrySet)
    {
        super();
        this.entries = (entrySet == null ? new LinkedList<>() : entrySet);
          ...
          pattern = Pattern.compile(".*" + text1 + ".*", Pattern.CASE_INSENSITIVE);
                ...
                if (!entries.isEmpty())
                {
                    ...
                    if (!isPopupHidden())
                    {
                        ...
                        {
                            entriesPopup.show(AutoCompleteTextFieldBarcodeAndItemMap.this, Side.BOTTOM, 0, 0);
                        }
                    }
                } else
                {
