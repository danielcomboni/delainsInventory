...
public class PurchasesClearanceDialog {
	...
	private void saveClearance() {
		...
		AuditHistory auditHistory = AuditHistoryHibernation.auditValues( " a credit purchase cleared", UserLoggedIn.getUserLoggedIn() );
//		AuditHistoryManipulation.populateTableWithRefreshing();
		AuditHistoryData.theData.add(auditHistory);
//		AuditHistoryFrame.addAuditHistoryToTable(auditHistory);
	}
