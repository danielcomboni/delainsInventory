...
public class PurchaseReturnDialog extends BorderPane {
				...
				final TableCell < PurchaseReturn, Void > cell = new TableCell < PurchaseReturn, Void >() {
...

					{
						btn.setOnAction( ( ActionEvent event ) -> {
							...
							// System.out.println("selectedPurchaseReturn: " + data);
	...
	private void saveAmountReturned() {
		...
		System.out.println( "purch amount paid bef: " + purchase.getAmountPaid() );
		...
		System.out.println( "purch amount paid after: " + amountPaidOfPurchaseAfterSubtraction );
